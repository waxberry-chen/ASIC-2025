...
/* -------------- 8 read data control: choose data from mem or return buffer -------------- */
    ...
    //  TODO: generate rdata_ret for uncache
...
/* -------------- 11 write back buffer: store the cache line or data to be write back -------------- */
    ...
    always_ff @(posedge clk) begin
        if(!rstn) begin
            ...
            //  TODO：generate wbuf for uncache here
...
/* -------------- 12 miss address buffer: store the address of the cache line to be write -------------- */
    always_ff @(posedge clk) begin
        if(!rstn) begin
            ...
            //  TODO: generate maddr_buf for uncache here
            maddr_buf <= {
...
/* -------------- 14 memory settings -------------- */
    //  TODO: generate signals for uncache 
...
/* -------------- 15 main FSM: mainly for read -------------- */
    ...
    always_comb begin
        ...
        IDLE: begin
            if(rvalid_pipe || wvalid_pipe) begin
                //  TODO：generate next_state for uncache here
        ...
        MISS: begin
            if(fence_valid_pipe) begin
                ...
                //  TODO: fix next_state to support uncache here
                next_state = REFILL;
            end
            else begin
                next_state = MISS;
    ...
    always_comb begin
        ...
        IDLE: begin
            if(rvalid_pipe || wvalid_pipe) begin
                //  TODO: generate output for uncache here
...
/* -------------- 16 write fsm: for write back-------------- */
    ...
    //  TODO: fix write_num generation for uncache here
    ...
    always_comb begin
        ...
        INIT: begin
            if(wfsm_en) begin
                //  TODO: generate wfsm_next_state for uncache here
